document.addEventListener('DOMContentLoaded', function () {
    ...
    if (searchInput && searchButton && searchResults) {
        var sitePages = [
            ...
            { title: 'Chrysanthemum Tea for Dry-Eye Days',     url: 'article-chrysanthemum-tea.html',          keywords: 'chrysanthemum tea autumn ritual dry eyes Chinese folk tea seasonal habits traditional beverage eye comfort flower steam' },
