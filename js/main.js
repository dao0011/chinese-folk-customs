document.addEventListener('DOMContentLoaded', function () {
    ...
    if (searchInput && searchButton && searchResults) {
        var sitePages = [
            ...
            { title: 'Chrysanthemum Tea for Tired Eyes',     url: 'article-chrysanthemum-tea.html',          keywords: 'chrysanthemum tea autumn ritual tired eyes Chinese folk tea seasonal habits traditional beverage eye comfort flower steam' },
